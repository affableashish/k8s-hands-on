...
This is a continuation of Kubernetes course from Microsoft Learn. So, it's helpful to finish [this section](docs/k8s-msftlearn.md#kubernetes) before reading this.
