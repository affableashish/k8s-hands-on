...
3. Debugging by getting into the pod and get the terminal (bash for eg.) from in there
   ...
   <img width="750" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/789efdfc-1d77-4bfe-8392-24b433c70c98">
4. Delete Pods
   ````
   kubectl delete deployment [name]
   ````
   
   <img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/b549874e-87a1-4fd6-ba1e-fc2625d0e5d8">
5. Using config files to do deployments
   ...
   <img width="300" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/624db0b7-1660-49e2-9dd2-056f6ed9b962">

**Summary:**  
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/847d015b-1085-459f-94d5-22b7f48c3559">  
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/54533231-60fe-4f3f-98c9-504bb5ad2d71">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/754f9518-250a-4802-8720-9cd1521f6c0b">

Each configuration file has 3 parts:  
1. Metadata
2. Specification
3. Status (This part is automatically generated and added by K8s)  
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/333a0dc3-e0a7-4879-b857-5b0c679679c5">

   K8s gets status data from `etcd` database.
   `etcd` holds the current status of any K8s component.

#### Blueprint for Pods (Template)
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/2fd8c270-f25b-4be1-a802-0e565390599d">
...
1. Connecting Deployment to Pods  
   ...
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/eaa3face-37d5-4149-8963-00b5b08b2549">
...
2. Connecting Services to Deployments  
   ...
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/5ae2b2a1-f84b-48db-bf8a-25be3247c6c2">

   Example:  
   Service has `spec:ports` configuration and deployment has `spec:template:spec:containers:ports` configuration:  
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/8fcb98bd-fc49-4acc-93b3-970148742ed8">

#### Ports in Service and Pod
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/fbcaa9c7-61a1-498c-864f-0f71af2d10e6">

#### Example
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/21ec293e-4579-44d5-907e-acff811b436b">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/a7aea357-a4f9-4ab1-a81e-c470a5dc3060">
...
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/c0420032-d53b-4a61-8fab-65de95579945">
...
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/79eee145-8f9f-4e20-b663-5313a7c25661">
...
<img width="400" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/1ef6b94c-27cc-42ea-a4bd-69835d7011cc">
...
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/b6c20141-e2ed-4712-80d1-05dc73912828">
...
Check it out:  
<img width="750" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/ac0b67c1-2c53-4300-b776-ca515fbf6815">
...
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/884d849b-96a5-409f-87d4-37e48eb82ce8">

### Namespace
Way to organize resources.

You can put your object/ resource into some namespace in the .yaml configuration file.  
<img width="350" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/6b58171f-c4a1-4863-91f4-80f5b7812987">

**Why?**

1. To group resources into different namespaces.  
   <img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/699c0798-624e-4374-8fe5-18af861fef02">

2. Use same cluster by different teams.  
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/6d2809d6-83b0-49cd-aceb-dc40f09f4e17">

3. Resource sharing: Staging and Development.  
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/5da2c1b1-931e-4796-b972-570a517ef9a2">

4. Set access and resource limits.  
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/80a7b5cb-fbbb-4f24-9aa6-9575d4944bc9">

You **can access** service in another Namespace:

<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/d427f54a-b0f1-4623-81ce-2ec6bcf910f6">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/0a224443-b673-45b4-829e-b49a7749c7de">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/f43a4b47-8075-4ef3-bb91-269b7239b503">

Ingress makes it better:  
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/08c8836d-d372-4c37-888a-80a9cb875635">
...
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/a78853c4-b1ee-4082-99b1-6d9e484fd783">

#### Ingress and internal service configuration
<img width="750" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/88972574-7f1d-426f-8caa-b4df5b6065d8">
...
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/f23b89da-c00e-451f-9ff5-686cc5c47764">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/6edf9cb0-bbf1-4539-aee7-383903e7a45b">

#### Ingress Controller
1. Evaluates all the rules defined in the cluster.  
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/b6e2ba98-c58b-4999-b773-2e87c3ac8705">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/e8228d68-cadd-4970-b66c-510223223ca8">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/8499ad31-76a4-41e1-ae5d-0924cef3b327">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/d27794bd-aedc-4e65-906e-b914881c8c71">
...
<img width="400" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/74d046fb-ed95-4daf-8198-7cea9f592ae3">
...
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/0d80b601-6a6c-4c03-98f4-17775b2e183f">
...
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/784a680b-ffaa-466a-9c6a-6dc0d212a30e">
...
<img width="550" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/93259521-3b0c-4526-b34a-ad7fe9a1d555">
...
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/e594e2e9-1228-40c8-a946-9c9ab7693a8c">
...
<img width="750" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/85c7e0b0-aaf9-4f8d-9cba-c497f64599c5">

#### Multiple paths for same host
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/6d78b75f-bb8a-44c0-b4e8-bc6111e88214">

#### Multiple sub-domains or domains
You can also have multiple hosts with 1 path. Each host represents a subdomain.

<img width="300" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/e0e61b6e-ab95-4335-8215-64a18fb42727">

#### Configuring TLS certificate - https
<img width="750" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/bd5a0a9f-7165-4030-96c6-a4217aee484c">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/9e221f9d-e32f-43b1-94c6-7aaae9f8a1af">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/3931aca8-749a-4200-a0c3-577b69455f32">

The values come from `values.yaml` file.

<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/f248feaf-2c03-41c2-a705-797405a1c787">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/039605b5-2e17-4e06-850f-17445683f955">

#### Helm helps deploying same app across different environments
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/e0d3f594-f21a-4b81-a733-b5318a3c695d">

#### Helm chart structure
<img width="150" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/124b26be-9dae-4b47-9e93-e162c474195f">
...
<img width="350" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/69fa3fb5-0cdc-42f3-9fbd-4a4637765c3b">
...
1. We need a storage that doesn't depend on the pod lifecycle.  
   <img width="400" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/7584ed59-ff6d-475b-b705-cffb41323a3d">
2. Storage must be available on all nodes.  
   <img width="450" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/94987239-4ba4-46e5-a2c9-56c3f6db9c4b">
...
3. Needs actual physical storage.  
   <img width="550" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/e65c8cf7-7d25-47e0-a3c8-e9307869243f">
4. Example that uses Google cloud:  
   <img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/af252f0c-4df7-45d3-90e3-5aec28e68ae4">
5. They are NOT namespaced.  
   <img width="500" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/ebc1eea6-1336-4c6d-b8ef-bb85f45f2356">

#### Persistent Volume Claim
Application has to claim the Persistent volume.

<img width="500" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/1a383fc1-829c-4ea6-acc8-8ff59232e688">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/a2bd62e8-f5d4-40ae-aa48-1673ae95f8b3">

Note: PVClaims must exist in the same namespace as the pod.

You use that claim in the Pods configuration like so:  
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/fee3ae01-a2e6-48f0-a149-ae3f9823df03">

**Mounting volume:**  
<img width="500" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/4d860872-729b-41e2-ad93-4c4ecde0411c">

#### Different volume types in a Pod
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/df181cc9-b598-48f9-b87b-8700650c4b50">

#### Storage Class
Storage class provisions persistent volumes dynamically when PersistentVolumeClaim claims it.  
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/a356b34f-e2b1-42ad-8cf0-58124dab2754">

Using Storage class:  
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/04677f2e-2834-416f-86cc-c99e44fca23f">

Flow:  
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/87506ae1-55ae-40d5-b8c3-1b0f35034891">
...
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/c58b7dc3-befe-436c-8bbf-0796aa3567d4">

#### Deployment vs StatefulSet
**Deployment:**

<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/e43dcd7d-baf8-4d56-9584-d89475c879ac">

When you delete one, one of those pods can be deleted randomly. 

**StatefulSet:**

<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/71a6477b-143f-4d80-aa04-6fcc427b3905">

#### Pod Identity

<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/1e3c1181-a506-41c4-8746-6fecee9048b4">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/284d1af5-84ba-48cd-bae7-9328cf9b15a6">

The workers continuously synchronize data.  
PV means Persistent volume.

#### Pod state 
<img width="550" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/036fb5c8-bcb1-4fa2-9f66-5a38383a0b93">
...
#### Pod Identity
<img width="550" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/344b5add-a958-45f7-9efd-7dd07905c50b">
...
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/8cb0d78d-8e29-483d-b471-ebf6d66b1199">

2 characteristics:  
<img width="500" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/a4bbcbc5-21cb-4494-aa64-2aa766578a99">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/f677caad-fd51-47eb-b1cd-943194ddd6c2">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/2dfe7d6e-90a5-4407-975c-5b2cc5afc79b">

#### ClusterIP Services
This is a default type, so when you create a service and don't specify the type, this is what you'll get.

<img width="300" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/c87f3b55-c180-4008-a9a8-a79ab1b299a9">
...
<img width="550" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/ee490118-8260-400e-b21a-7a20c0e78557">

**Pod gets an IP address from a range that is assigned to a Node.**

<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/d48f38c7-1f29-4667-9adc-60501d235eb7">

Let's say you access the app through the browser:

<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/cbf516f7-4038-4d7f-b443-63db0cb4f932">

The ingress rule and app service yaml contents look like this:

<img width="450" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/8fa1242c-a1f5-485a-b81c-baaf5101cf80">  
...
<img width="500" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/f449dc1d-2fbb-4aba-b1b9-c0d9feb2186c">

**Which port to forward request to?**  
<img width="800" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/3cb110d9-424d-4988-a028-e3cbc6cf920e">
...
<img width="450" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/6f335791-f1c7-4877-a1e6-9d7d52bb7136">

**Multi-Port Services:**  
<img width="800" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/f04cb733-52ad-43d1-a835-499867807101">

When you have multiple ports defined in a service, you have to name them.

<img width="250" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/32f013d4-2240-461d-a0c5-829478b9e1c0">
...
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/48b67607-a0fb-4652-a069-7150e9b88233">
...
<img width="800" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/ae95e98b-5227-4a7d-a7af-4a2e5f7925fe">
...
<img width="650" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/ec3c57fc-2628-4cb9-82b7-5a69fb8f7f0a">
...
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/941eb8bd-0a3b-44cf-b3f4-7cfe7ed4aa47">
...
<img width="600" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/4ea4d459-2053-4784-8eb6-713b9936d3ef">
...
<img width="250" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/0e41ac26-8297-4c25-8881-59b261b37261">

It works like this:  
<img width="700" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/c717755a-24ad-4a2d-98bb-39b9391906d1">
...
<img width="800" alt="image" src="https://github.com/akhanalcs/k8s-hands-on/assets/30603497/4706aeb2-8daf-4364-a820-ede12058f9c9">
